...
public class Messages {
	...
	//Collections
	public static String colPersonas 	= "Personas"; 
	public static String colPuntosDR 	= "PuntosDR"; 
	...
	public static String rolNotFound 	 = "No se encuentra el registro id: %s de Rol";
	public static String usrNotFound 	 = "No se encuentra el registro id: %s de Usuario";
